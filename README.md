...
```
Objects that are interested in those news items subscribe to the news item, state what info they want, pass parameters if needed (eg id) and give the callback function they want used whenever anything happens:
```
