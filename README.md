...
It uses webcomponents and a simple pubsub pattern to allow each component to subscribe and/or publish to the datastore.
...
Suddenly I saw the light. Plain ES6 web components and no frameworks. Hence this demo, which lockes in as follows:
```-------------------------------------------------------------------------------
 Language            Files        Lines         Code     Comments       Blanks
-------------------------------------------------------------------------------
 CSS                     1           56           49            0            7
