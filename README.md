...
```
but then it would be more tricky to assign specific requests/callbacks to each ewInfo.

Also I've not bothered with shadow dom as I like using Bootstrap to control overall style.
